...
model = dict(
    ...
    rpn_head=dict(
        ...
        loss_cls=dict(
            type='FocalLoss', use_sigmoid=True, loss_weight=1.0, gamma=2.0, alpha=0.25),
...
data_root = 'data/'#drive/My Drive/Mmdetection/'
img_norm_cfg = dict(
...
data = dict(
    ...
    train=dict(
        type=dataset_type,
        ann_file=data_root + 'VOC2007/trainval.json', #drive/My Drive/chunk.json',
...
load_from = 'Model/cascade_mask_rcnn_hrnetv2p_w32_20e_eunji/original/epoch_14.pth' #Table detection, fine-tuned on TableBank Latex # resume_from
workflow = [('train', 1)]
